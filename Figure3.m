%This script produces Figure 3 and related SI figures
...
% % #Fraction OTU vs length of series
% figure
% for i=1:15
% plot(size(abd{i,1},1),length(jumpingOTU{i,1})/size(Dpeaks2{i,1},1),'o')
% hold on
% end
% 
% figure
% for i=1:15
% plot(abd{i,1}(end,1)-abd{i,1}(1,1),length(jumpingOTU{i,1})/size(Dpeaks2{i,1},1),'o')
% hold on
% end
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%Figures 3A-B: examples of abundance time-series with K jumps
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
i=11;  %Individual M3
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
% Figure 3C: bar plot of OTUs where we detect a jump in K and whose ̃Φ is increasing, where we detect a jump in K but ̃Φ is flat
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
% Figure 3D and S?: histograms of times at which jumps in K are detected
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
figure
count=1;
for i=1:16
...
%slope vs peak height
figure
for i=1:16
    subplot(4,4,i)
    plot(max([Dpeaks1{i,1}(:,2), Dpeaks2{i,1}(:,2)]'),slope{i,1},'o') 
    hold on
    plot(1:300, ones(1,300)*threshold(i),'k--')
    set(gca,'xscale','log')
    xlabel('Peak hight')
    ylabel('Slope')
end
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%Fig. S?: Example of our method to identify jumps in the abundance time series.
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
i=11; %individual M3
x=abd{i,1}(:,1)-abd{i,1}(1,1); %days, starting from 0
y=relabd{i,1}(:,id{i,1}); %abundances
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%Figure S?: examples of cases where Φ(T) is increasing even though no jump in K is detected or viceversa
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
